...
Button_Deri = HoverButton(frame, text="Deri", height=2, width=5, font=('Comic sens MC', 12, 'bold'),
                            borderwidth=2, relief="raised", activebackground="red", bg='#FD5603', anchor="center",
                            command=lambda: borrar_todo())
Button_Deri.grid(column=4, row=1, pady=2, padx=2)
# fila 2
...
Button_Intgr = HoverButton(frame, text="Intgr", height=2, width=5, font=('Comic sens MC', 12, 'bold'),
                            borderwidth=2, relief="raised", activebackground="red", bg='#FD5603', anchor="center",
                            command=lambda: borrar_todo())
Button_Intgr.grid(column=4, row=2, pady=2, padx=2)
# fila 3
...
Button_tan = HoverButton(frame, text="Tan", height=2, width=5, font=('Comic sens MC', 12, 'bold'),
                            borderwidth=2, relief="raised", activebackground="red", bg='#FD5603', anchor="center",
                            command=lambda: borrar_todo())
